    ...
    <Slide title="Cast, Characters, and Legal Framework" subtitle="Who is who, and how the HOA is governed.">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 border border-slate-200">
          <h3 className="text-xl font-bold mb-4 font-serif italic border-b border-slate-300 pb-2">Relationships</h3>
          <ul className="list-disc pl-5 text-base text-slate-700 space-y-2">
            <li><strong>Min</strong> controls <strong>SO UK Investments</strong> and <strong>Lotus House</strong>.</li>
            <li><strong>The Board</strong> controls <strong>Deschutes Heights HOA</strong>.</li>
            <li>Prior to 2026, <strong>Min</strong> controlled the Board as the developer-appointed director(s).</li>
            <li>As of 2026, seven homeowners control the Board.</li>
            <li><strong>VIS Group</strong> works for the HOA and acts as its agent.</li>
            <li><strong>VIS Group</strong> selects vendors including <strong>Simply Home</strong> and <strong>Precision Groundworks</strong>.</li>
            <li>Vendors contract with and work for the HOA.</li>
          </ul>
        </div>
      </div>
